  ...
  const handleUpload = async (file: File) => {
    ...
    try {
      ...
      const { error } = await supabase.from('materials').insert({
        ...
        session_id: null, // NULL = booking-level material
        uploaded_by: user.id,
            ...
            <div className="space-y-6">
              ...
              <div className="card">
                ...
                <p className="text-gray-600 mb-4 text-sm">
                  📚 Share files with your tutor (homework, questions, etc.). Materials uploaded here 
                  will be visible in <strong>all sessions</strong> of this booking.
                </p>
              ...
              <div className="card">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Materials shared across all sessions in this booking.
                </p>
                <MaterialsList
                  bookingId={bookingId}
                  materials={materials}
